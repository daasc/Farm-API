...
import type { ListQuery, FarmData} from '../types/index.js';
...
class FarmController {
    async createFarm(data: FarmData) {
      try {
      const { admin, password, email, ...farmDataWithoutAdmin } = data;
      ...
      const newFarm = await prisma.farm.create({ data: { ...farmDataWithoutAdmin, email, passwordHash } });
